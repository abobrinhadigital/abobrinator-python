...
### Removed
- **A Alma do Projeto:** Este repositório foi aposentado e substituído por uma arquitetura infinitamente superior escrita em Ruby. Descanse em paz, `google-genai`.
